...
export const FEATURE_REQUIREMENTS = {
  ...
  documentEmailShare: {
    minimumPlan: "standard",
    label: "Email invoice and PO",
    message: "Emailing invoices, purchase orders, and work orders is available on Standard, Pro, and Business plans.",
  },
  razorpayCollections: {
    minimumPlan: "standard",
...
export const PLAN_CATALOG = {
  ...
  standard: {
    ...
    amount: 199,
    monthlyAmount: 199,
    annualAmount: annualize(199),
    currency: "INR",
    billingCycle: "yearly",
    priceDisplay: "INR 199/month, INR 2,388 billed yearly",
    limits: {
      companies: 1,
      customers: 500,
    ...
    implementation: {
      status: "active",
      ready: ["WhatsApp sharing", "Email invoice and PO", "Razorpay invoice collection links", "Higher limits", "WordPress paid access flag", "Recurring invoice metadata", "Branding removal controls", "Automatic recurring scheduler"],
      pending: [],
    },
  },
  pro: {
    ...
    currency: "INR",
    billingCycle: "yearly",
    priceDisplay: "INR 499/month, INR 5,988 billed yearly",
    limits: {
      companies: 5,
      customers: 2500,
  ...
  business: {
    ...
    currency: "INR",
    billingCycle: "yearly",
    priceDisplay: "INR 999/month, INR 11,988 billed yearly",
    limits: {
      companies: UNLIMITED,
      customers: UNLIMITED,
