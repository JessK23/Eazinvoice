...
final class EazInvoice_Plugin {
	...
	private function default_settings() {
		return array(
			...
			'api_settings_url' => 'https://eazinvoice.com',
			'workspace_url' => 'https://eazinvoice.com',
			'upgrade_url'   => 'https://eazinvoice.com',
	...
	public function sanitize_settings( $input ) {
		...
		return array(
			...
			'api_settings_url' => esc_url_raw( $input['api_settings_url'] ?? 'https://eazinvoice.com' ),
			'workspace_url' => esc_url_raw( $input['workspace_url'] ?? 'https://eazinvoice.com' ),
			'upgrade_url'   => esc_url_raw( $input['upgrade_url'] ?? 'https://eazinvoice.com' ),
